...
│   └── main/
│       └── java/
│           └── com/example/sentimentaiproject/
│               ├── controller/     # REST контроллеры
│               ├── model/          # ML модель и логика
│               ├── config/         # Конфигурации
...
bash
# Проверьте наличие model.onnx в classpath
# Используется fallback анализатор
Проблемы с Ingress
...
👥 Автор
[Ваше Имя] - Студент курса по разработке и развертыванию ИИ-приложений
